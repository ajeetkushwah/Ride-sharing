    ...
    <div className="">
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="mt-6 w-full">
          <Link
            to={"/captain-home"}
            className="w-full flex text-lg justify-center mt-5 bg-green-500 text-white font-semibold rounded-lg p-2"
          >
            Finish Ride
          </Link>

          <p className=" mt-10 text-xs">
            Click on finish ride butttonn if you have completed the payment.
          </p>
        </div>
      </div>
    </div>
